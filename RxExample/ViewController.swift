    ...
    func setUp() {
        ...
        textField.rx.text // Observable property
            ...
            .subscribe(onNext: { query in // Here we subscribe to every new value, that is not empty (thanks to filter above).
                ...
                let parameters : [String : Any] = ["top" : 50, "skip" : 0, "FindString" : query]
                manager.rx.json(.get, "https://kvpos.com:9033/customers", parameters: parameters, encoding: URLEncoding.default, headers: headers)
